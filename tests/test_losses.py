...
class ModelyTrainingTest(unittest.TestCase):
    ...
    def test_losses_compare_closed_loop_state(self):
        ...
        self.TestAlmostEqual(test.performance['validation_dataset_0.50']['error1']['mse'], test._training['error1']['val'][-1])
        self.TestAlmostEqual(test.performance['validation_dataset_0.50']['error2']['mse'], test._training['error2']['val'][-1])
